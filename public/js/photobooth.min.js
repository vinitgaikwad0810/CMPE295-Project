...
Photobooth = function (e) {
  ...
  .catch(function(err) {
    ...
    this.onImage = function () {
        ...
        if (t == 0) {
            t = T.videoHeight / (T.videoWidth / e);
            if (isNaN(t)) {
                t = e / (4 / 3);
            }
        }
    ...
    var i = function (e, t) {
            ...
            var i = 50, s = 50, o = e.getElementsByClassName("handle")[0], u = e.getElementsByClassName("slider")[0],
                a = new r(o);
            a.onMove = function (e) {
                f(i + e)
            }, a.onStop = function (e) {
            ...
            var s = 30, o = 30, u = 100, a = 100, f = 30, l = 30, c = 100, h = 100, p = !1,
        ...
        }, o = 0, u = 0, a = 0, f = !1, l = !1, c = null, h = this, p = e.offsetWidth, d = e.offsetHeight,
        v = function (e, t) {
    ...
    var w = y("canvas"), E = w.getContext("2d"), S = b.getElementsByTagName("canvas")[0], x = S.getContext("2d"),
        T = y("video");
    T.autoplay = !0;
    var N = g("noWebcam");
    ...
    g("trigger").onclick = function () {
        ...
        if (f) t.getContext("2d").drawImage(T, Math.max(0, e.x - (p - T.videoWidth) / 2), Math.max(e.y - (d - T.videoHeight) / 2), e.width, e.height, 0, 0, e.width, e.height); else {
    ...
    var A = function (e) {
        ...
        N.style.display = "none", t.call(navigator, {video: facingMode: { exact: "environment" }}, A, O)
    }, _ = function (e, t, n) {
        ...
        for (var r = 0; r < n.length; r += 4) {
            var i = n[r] / 255, s = n[r + 1] / 255, f = n[r + 2] / 255, c = Math.max(i, s, f), h = Math.min(i, s, f), v,
                g, y = (c + h) / 2;
            if (c == h) v = g = 0; else {
                var b = c - h;
            ...
            if (g === 0) i = s = f = y; else {
                var w = y < .5 ? y * (1 + g) : y + g - y * g, S = 2 * y - w;
